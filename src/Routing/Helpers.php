...
use Fc9\Api\Http\Response\Factory;

/**
 * @property \Fc9\Api\Dispatcher                                            $api
 * @property \Illuminate\Auth\GenericUser|\Illuminate\Database\Eloquent\Model $user
 * @property \Fc9\Api\Auth\Auth                                             $auth
 * @property \Fc9\Api\Http\Response\Factory                                 $response
 */
trait Helpers
{
    /**
     ...
     *
     * @param string|\Fc9\Api\Contract\Http\RateLimit\Throttle $class
     * @param array                                              $options
     *
     * @return void
     */
     ...
     *
     * @return \Fc9\Api\Http\Response\Factory
     */
