...
namespace Fc9\Api\Console\Command;

use ReflectionClass;
use Fc9\Blueprint\Writer;
...
class Docs extends Command
{
     ...
     * @param \Fc9\Blueprint\Blueprint $blueprint
     * @param \Fc9\Blueprint\Writer    $writer
     * @param string                     $name
