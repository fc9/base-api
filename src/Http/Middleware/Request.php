...
use Fc9\Api\Event\RequestWasMatched;
use Fc9\Api\Http\Request as HttpRequest;
use Illuminate\Contracts\Container\Container;
use Fc9\Api\Contract\Debug\ExceptionHandler;
use Fc9\Api\Contract\Http\Request as RequestContract;
...
class Request
{
     ...
     *
     * @var \Fc9\Api\Contract\Debug\ExceptionHandler
     */
    protected $exception;
     ...
     * @param \Fc9\Api\Contract\Debug\ExceptionHandler   $exception
     * @param \Fc9\Api\Routing\Router                    $router
     * @param \Fc9\Api\Http\RequestValidator             $validator
