...
namespace Fc9\Api\Routing\Adapter;
...
use Fc9\Api\Exception\UnknownVersionException;
...
class Lumen implements Adapter
{
    ...
    protected function removeMiddlewareFromApp()
    {
        ...
        foreach ($oldMiddlewares as $middle) {
            if ((new ReflectionClass($middle))->hasMethod('terminate') && $middle != 'Fc9\Api\Http\Middleware\Request') {
