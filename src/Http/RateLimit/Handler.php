...
namespace Fc9\Api\Http\RateLimit;
...
use Fc9\Api\Http\RateLimit\Throttle\Route;
use Fc9\Api\Contract\Http\RateLimit\Throttle;
use Fc9\Api\Contract\Http\RateLimit\HasRateLimiter;
...
class Handler
{
     ...
     *
     * @var \Fc9\Api\Contract\Http\RateLimit\Throttle
     */
    protected $throttle;
     ...
     *
     * @param string|\Fc9\Api\Contract\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
     ...
     *
     * @return \Fc9\Api\Contract\Http\RateLimit\Throttle
     */
     ...
     *
     * @param callable|\Fc9\Api\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
